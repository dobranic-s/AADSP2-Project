...
__memX DSPfract* leftChannelIn;
__memX DSPfract* rightChannelIn;
__memX DSPfract* leftChannelOut;
__memX DSPfract* rightChannelOut;
__memX DSPfract* leftSurroundChannelOut;
__memX DSPfract* rightSurroundChannelOut;
__memX DSPfract* lowFreqEffChannelOut;
